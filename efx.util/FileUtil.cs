...
namespace efx
{
	...
	#	endregion
		...
		nex:
			...
			User32.SendMessage(lv.Handle,stuff.SETIMAGELIST,stuff.LVSIL_NORMAL,Win32.GetImageListPointer(Pth,lgIco));
			User32.SendMessage(lv.Handle,stuff.SETIMAGELIST,stuff.LVSIL_SMALL,Win32.GetImageListPointer(Pth,smIco));
