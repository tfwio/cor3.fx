...
namespace WTF.drawing.render.surface
{
		public interface IBufferedControlRenderer: IBufferedRenderer
		{
			RenderRegionDict Renderers { get;set; }
			void InitializeRenderers(IControlInfo ctl);
		}
}
