...
{
	public interface IClientApiControlManager<TClient, TApi>
	{
		void FilterCall(object sender, ApiEventArgs<TApi> data);
		void Call(ApiEventArgs<TApi> data);
		void Call(TApi api, params object[] data);
		void Call(TApi api);
		void Call(object sender, TApi api, params object[] data);
		void Call(object sender, TApi api);
		void Call(object sender, ApiEventArgs<TApi> data);
