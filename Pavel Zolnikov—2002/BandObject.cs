...
namespace win32
{
	...
	public class BandObject : UserControl, IObjectWithSite, IDeskBand, IDockingWindow, IOleWindow, IInputObject 
	{
		...
		/// </summary>
		protected WebBrowserClass	_Explorer;

		public DWebBrowserEvents_Event WebEvents { get { return (DWebBrowserEvents_Event)_Explorer; } }
		public IWebBrowser2 Web2 { get { return ((IWebBrowser2)_Explorer); } }
...
//			DWebBrowserEvents_Event events = WebEvents;
		}
		...
		{
			if( BandObjectSite != null ) Marshal.ReleaseComObject( BandObjectSite );
			if( _Explorer != null ) {
