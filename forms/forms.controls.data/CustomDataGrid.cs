...
namespace cor3.forms.controls.data
{
	public class CustomDataGrid : DataGrid
	{
		...
		public string CustomBackgroundColorLight { get { return GetStringFromColor(customBackgroundColorLight); } set { customBackgroundColorLight = GetColorFromString(value); this.Invalidate(); } }
		[Category("Appearance"), DefaultValue(typeof(Color), "1,51,51,51"), Description("Second shade of background color.")]
		public string CustomBackgroundColorDark { get { return GetStringFromColor(customBackgroundColorDark); } set { customBackgroundColorDark = GetColorFromString(value); this.Invalidate(); } }
		...
		public string CustomCellColorLight { get { return GetStringFromColor(customCellColorLight); } set { customCellColorLight = GetColorFromString(value); this.Invalidate(); } }
		[Category("Appearance"), DefaultValue(typeof(Color), "1,69, 69, 69"), Description("Second shade of cell color.")]
		public string CustomCellColorDark { get { return GetStringFromColor(customCellColorDark); } set { customCellColorDark = GetColorFromString(value); this.Invalidate(); } }
		[Category("Appearance"), DefaultValue(typeof(Color), "1,255,255,255"), Description("First shade of header color.")]
		public string CustomHeaderColorLight { get { return GetStringFromColor(customHeaderColorLight); } set { customHeaderColorLight = GetColorFromString(value); this.Invalidate(); } }
		[Category("Appearance"), DefaultValue(typeof(Color), "1,234,234,234"), Description("First shade of header color.")]
		public string CustomHeaderColorDark { get { return GetStringFromColor(customHeaderColorDark); } set { customHeaderColorDark = GetColorFromString(value); this.Invalidate(); } }
		...
		public string CustomHoverColor { get { return GetStringFromColor(customHoverColor); } set { customHoverColor = GetColorFromString(value); this.Invalidate(); } }
