...
namespace OutlookStyleControls
{
	public class OutlookGrid : DataGridView
	{
		...
		public new DataGridViewRow RowTemplate { get { return base.RowTemplate;} }

		private IOutlookGridGroup groupTemplate;
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IOutlookGridGroup GroupTemplate { get { return groupTemplate; } set { groupTemplate = value; } }

		private Image iconCollapse;
		[Category("Appearance")]
		public Image CollapseIcon { get { return iconCollapse; } set { iconCollapse = value; } }

		private Image iconExpand;
		[Category("Appearance")] public Image ExpandIcon { get { return iconExpand; } set { iconExpand = value; } }
		...
		public void CollapseAll() { SetGroupCollapse(true); }
		public void ExpandAll() { SetGroupCollapse(false); }
		...
		private void SetupColumns()
		{
			...
			if (dataSource == null) return; else list = dataSource.Rows;
			...
			foreach (string c in dataSource.Columns)
			{
				...
				if (column == null) index = Columns.Add(c, c);
				else
					index = column.Index;
